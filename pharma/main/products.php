...
<table class="hoverTable" id="resultTable" data-responsive="table" style="text-align: left;">
	<thead>
		<tr>
			...
			<th width="6%"> QTY Remaining</th>
			<th width="5%"> Qty Bought </th>
			<th width="8%"> Qty Used </th>
	...
	<tbody>
			...
			<?php
				...
				include('../connect.php');
				$result = $db->prepare("SELECT *,qty_sold-qty as total FROM products ORDER BY product_id DESC");
				$result->execute();
