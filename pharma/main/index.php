...
?>
	...
	<div class="span2">
          <div class="well sidebar-nav">
			...
			<li><a href="customer.php"><i class="icon-group icon-2x"></i> Students</a>                                    </li>
	...
	<div class="contentheader">
			...
			<font style=" font:bold 44px 'Aleo'; text-shadow:1px 1px 25px #000; color:#fff;"><center>stella Maris Schools, Abuja Clinic.</center></font>
<div id="mainmain">
...
<a href="customer.php"><i class="icon-group icon-2x"></i><br> Students</a>     
